...
cam_feed_page = [
    ...
    [
        ...
        # sg.Image(filename='', key="cam_feed", size=(320,240), expand_x=True, expand_y=True)
    ],
]
...
layout = [
    ...
    # [sg.Column(cam_feed_page, key="cam_feed_page", visible=False)]
]

# window = sg.Window(title="KBBQ for KBBeginners", layout=layout, margins=(10, 10), size=(640, 480))
window = sg.Window("KBBQ for KBBeginners", layout=layout, margins=(10, 10), resizable=True,auto_size_buttons=True,auto_size_text=True).finalize()
window.maximize()
...
# # graph.DrawRectangle((80,-160), (800, 280), )
# # graph.DrawLine((440, -160), (440,280))
# # graph.DrawLine((80, 60), (800,60))
# # graph.DrawText("1", (260, 170), font="Arial 20")
# # graph.DrawText("2", (620, 170), font="Arial 20")
# # graph.DrawText("3", (260, -50), font="Arial 20")
# # graph.DrawText("4", (620, -50), font="Arial 20")
# # graph.DrawButton
